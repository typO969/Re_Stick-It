...
namespace StickIt.Models
{
   public class NoteModel : INotifyPropertyChanged
   {
      ...
      // Add this property to NoteModel class:
      public bool IsLocked
      {
         get => Props.IsLocked; // We need to add this to NoteProperties next
         set { if (Props.IsLocked == value) return; Props.IsLocked = value; OnPropertyChanged(); }
      }

      public double RotationAngle
      {
         get => Props.RotationAngle;
         set { if (Props.RotationAngle == value) return; Props.RotationAngle = value; OnPropertyChanged(); }
      }
